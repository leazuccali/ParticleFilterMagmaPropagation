...
# FONCTION PRINCIPALE
####################################################################################################################
def fonction_principale(Nb_particules, pas_temps, Nb_propag_init, Nb_pas_max, int_selec, type_selection, type_observations, pas, nobs, dossier_output):
    '''

    Args:
        Nb_particules: Nombre de particules
        pas_temps: pas de temps
        Nb_propag_init: Nombre de pas_temps en propagation libre initiale (pas_temps * nb_propag_libre = temps en secondes)
        Nb_pas_max: Nombre maximal de pas_temps de l'expérience
        int_selec: Nombre de pas_temps entre 2 assimilations
        type_selection: 'systematic','stratified','multinomial,'residual'
        type_observations: 'regulier','normal','random'
        pas: Si regulier : Pas de discrétiation de l'espace (tous les pas mètres)
        nobs: Si 'normal','random' : nombre d'observations considérées
        dossier_output:  "output_sauvegarde_plots"
...
if __name__ == '__main__':
    #lancement_propag_selec(100, 60, 60, 550, 10, 5)    #600   540  60   60

    # Nombre de particules
    nb_particules = 100
    # Pas de temps
    pas_temps = 60
    # Nombre de pas_temps en propagation libre initiale (pas_temps * nb_propag_libre = temps en secondes)
    nb_propag_libre = 60
    # Nombre maximal de pas_temps de l'expérience
    nb_pas_max = 550
    # Nombre de pas_temps entre 2 assimilations
    int_assimilation = 5


    # Type selection : 'systematic','stratified','multinomial,'residual'
    type_selection = 'systematic'
    # Type observation : 'regulier','normal','random'
    type_observations = 'regulier'

    #Si regulier : Pas de discrétiation de l'espace (tous les pas mètres)
    pas = 100
    # Si 'normal','random' : nombre d'observations considérées
    nobs = 600

    #Dossier de sortie :
    dossier_output = "/home/zuccalil/WS1-NAS/zuccalil/output_sauvegarde_plots_01.12.25_5_100m_regular_systematic"
